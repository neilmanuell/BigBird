...
public class BigBirdMissingKeyDecodingTest
{
    ...
    {
        assertThat( _recieved[URL_MISSING_KEY_DOCUMENT_XML].join( "," ), equalTo( _expected[URL_MISSING_KEY_DOCUMENT_XML].join( "," ) ) );
        assertThat( _recieved[URL_MISSING_KEY_DOCUMENT_DOCX].join( "," ), equalTo( _expected[URL_MISSING_KEY_DOCUMENT_DOCX].join( "," ) ) );
    }
}
}
