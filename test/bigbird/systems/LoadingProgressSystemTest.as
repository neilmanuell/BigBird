...
public class LoadingProgressSystemTest
{
    private var _game:Game;
    private var _progress:BigBirdProgress;
    private var _progressSignal:ProgressSignal;
    private var _classUnderTest:LoadingProgressSystem;
    ...
    public function before():void
    {
        ...
        _classUnderTest = new LoadingProgressSystem( _progress );
    ...
    public function removes_self_after_3_inactive_updates():void
    {
        ...
        assertThat( _game.getSystem( LoadingProgressSystem ), nullValue() );
    }
    ...
    public function does_not_removes_self_if_new_value_added():void
    {
        ...
        assertThat( _game.getSystem( LoadingProgressSystem ), notNullValue() );
    }
    ...
    private function createEntity( workDone:int, totalWork:int, isComplete:Boolean ):Entity
    {
        ...
        entity.add( new Loader( DOCUMENT_URL, factory ) );
